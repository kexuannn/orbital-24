...
const SignUpShelter = () => {
    ...
    const submit = async () => {
        ...
        if (!validEmails.includes(form.email)) {
            Alert.alert("Sign up error", "Your email is not valid. Please sign up as a user instead!");
            return;
        }
            ...
            <ScrollView>
                <View className="w-full h-full justify-center px-4 py-10">
                    ...
                    <Text className="text-darkBrown text-2xl font-psemibold">Sign up as a {''}
                        <Text className="text-red text-2xl font-psemibold">Shelter</Text>
                        <Text className="text-darkBrown text-2xl font-psemibold">:</Text>
                    </Text>

                    <View className="justify-left pt-5 flex-row gap-1">
                        <Text className="text-lg text-turqoise font-pregular">Are you a user?</Text>
                        <Link href="/sign-up" className=" underline text-lg text-red font-pregular">Sign up here instead!</Link>
                    </View>
